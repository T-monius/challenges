...
describe("Test Trinary class.", () => {
  ...
  describe("Test 'isValid'", () => {
    it('Recognizes a single digit valid trinary', () => {
      const trinary = new Trinary('1');
  
      assert(trinary.isValid());
    });
    it('Recognizes a multi-digit valid trinary', () => {
      const trinary = new Trinary('10');
  
      assert(trinary.isValid());
    });
    it('Recognizes an invalid single digit trinary', () => {
      const trinary = new Trinary('a');
  
      assert(!trinary.isValid());
    });
    it('Recognizes an invalid multi-digit trinary', () => {
      const trinary = new Trinary('hop');
